(function () {
  ...
  var TOOL_MARKETING_COPY = {
    ...
    colorConv: { subcopy: "HEX・RGB・HSL・CMYK・Labをタブで相互変換。無料・登録不要で色調整を効率化。", recommend: ["複数の色空間を行き来しながら調整したい方", "スライダーで色を直感的に微調整したい方", "デザイン実装前に色値を統一したい方"], faq: [ { q: "短縮HEXにも対応しますか？", a: "はい。#RGB と #RRGGBB の両方に対応しています。" }, { q: "どの値を変えても他形式は更新されますか？", a: "はい。HEX・RGB・HSL・CMYK・Lab は相互に連動して更新されます。" }, { q: "無料ですか？", a: "はい。" } ] },
    ...
    gradientCss: { subcopy: "線形グラデーションの CSS をリアルタイム生成。カラーピッカーと角度で調整し、コピーはコード右上のアイコンから。無料・登録不要でブラウザ内のみ。", recommend: ["背景用の linear-gradient を素早く作りたい方", "色と角度を変えながらプレビューとコードを見たい方", "ワンクリックで色と角度をランダムに試したい方"], faq: [ { q: "操作するとどうなりますか？", a: "色や角度を変えると、プレビューと CSS がその場で更新されます。" }, { q: "コピーはどこからできますか？", a: "CSS コード枠の右上にあるアイコンからコピーできます。" }, { q: "データは送信されますか？", a: "いいえ。処理はブラウザ内のみです。" } ] },
    meshGradientCss: { subcopy: "複数の radial-gradient を重ねたメッシュ風背景の CSS をリアルタイム生成。下地と4色をカラーピッカーで調整し、コピーはコード右上のアイコンから。無料・登録不要でブラウザ内のみ。", recommend: ["メッシュ風の背景を素早く試したい方", "重ねる radial-gradient のコード例が欲しい方", "ワンクリックで色の組み合わせをランダムに試したい方"], faq: [ { q: "本物の CSS mesh() ですか？", a: "いいえ。ブラウザ対応を踏まえ、radial-gradient を複数重ねた近似表現です。" }, { q: "グラデの位置は変えられますか？", a: "ツール上は固定パターンです。コードをコピーしたあと、at の座標を編集してください。" }, { q: "データは送信されますか？", a: "いいえ。処理はブラウザ内のみです。" } ] },
